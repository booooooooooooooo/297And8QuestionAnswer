...
#NOTE: modified by bo
from model import Model, MatchGRUCell
...
def main(_):
    ...
    qa = Model(embed_matrix, cfg.context_max_len, cfg.question_max_len, cfg.embed_size, cfg.lstm_num_hidden, cfg.max_grad_norm, cfg.start_lr, cfg.epochs, cfg.reg)
    ...
    with tf.Session(config=config) as sess:
        ...
        qa.evaluate_answer(sess, dataset, raw_answers, rev_vocab,
                           ...
                           sample=4000)
        #modified by bo
        qa.save_predictions(sess, dataset, raw_answers, rev_vocab)
