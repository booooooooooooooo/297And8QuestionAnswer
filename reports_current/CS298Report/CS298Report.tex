...
The train and validation process produces a brunch of Tensorflow graphs. The validation loss is used to choose best graph. Then the best graph is used to do testing.
